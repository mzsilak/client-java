...
public class ServiceRegistryRequestDTO implements Serializable {
    ...
    public ServiceRegistryRequestDTO(final String serviceDefinition, final SystemRequestDTO providerSystem,
                                     final String serviceUri, final String endOfValidity, final String secure,
    ...
    public String toString() {
        return new StringJoiner(", ", ServiceRegistryRequestDTO.class.getSimpleName() + "[", "]")
            .add("serviceDefinition='" + serviceDefinition + "'").add("providerSystem=" + providerSystem)
            .add("serviceUri='" + serviceUri + "'").add("endOfValidity='" + endOfValidity + "'")
            .add("secure='" + secure + "'").add("metadata=" + metadata).add("version=" + version)
