...
public class DeviceRegistryOnboardingWithCsrResponseDTO extends DeviceRegistryOnboardingResponseDTO implements
                                                                                                    Serializable {
    ...
    public DeviceRegistryOnboardingWithCsrResponseDTO(final long id, final DeviceResponseDTO device,
                                                      final String endOfValidity, final Map<String, String> metadata,
                                                      final int version, final String createdAt, final String updatedAt,
