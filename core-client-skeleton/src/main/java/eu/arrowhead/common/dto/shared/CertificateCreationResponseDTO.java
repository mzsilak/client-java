...
public class CertificateCreationResponseDTO implements Serializable {
    ...
    public CertificateCreationResponseDTO(final String certificate, final CertificateType certificateType,
    ...
    public CertificateCreationResponseDTO(final String certificate, final CertificateType certificateType,
                                          final KeyPairDTO keyPairDTO, final String certificateFormat) {
        this.certificate = certificate;
        this.certificateType = certificateType;
    ...
    public String toString() {
        return new StringJoiner(", ", CertificateCreationResponseDTO.class.getSimpleName() + "[", "]")
            .add("certificate='" + certificate + "'").add("certificateFormat=" + certificateFormat)
            .add("certificateType=" + certificateType).add("keyPairDTO=" + keyPairDTO).toString();
    }
}
