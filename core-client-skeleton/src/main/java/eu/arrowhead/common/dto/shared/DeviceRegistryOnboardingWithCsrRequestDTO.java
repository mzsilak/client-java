...
public class DeviceRegistryOnboardingWithCsrRequestDTO extends DeviceRegistryRequestDTO implements Serializable {
    ...
    //-------------------------------------------------------------------------------------------------
    public DeviceRegistryOnboardingWithCsrRequestDTO(final DeviceRequestDTO device, final String endOfValidity,
    ...
    //-------------------------------------------------------------------------------------------------
    public DeviceRegistryOnboardingWithCsrRequestDTO(final String deviceName, final String macAddress,
    ...
    public String toString() {
        return new StringJoiner(", ", DeviceRegistryOnboardingWithCsrRequestDTO.class.getSimpleName() + "[", "]")
            .add("certificateSigningRequest=" + certificateSigningRequest).add("parent=" + super.toString()).toString();
    }
}