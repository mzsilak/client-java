...
public class IdeIceMain implements Runnable {
    ...
    public static void main(String[] args) throws InterruptedException {
        final ConfigurableApplicationContext ctx = SpringApplication.run(IdeIceMain.class);
    ...
    public HttpServerCustomizer httpServerCustomizer() {
        return (server) -> server.registerClasses(IdaIceController.class, JacksonJsonProviderAtRest.class);
    }
